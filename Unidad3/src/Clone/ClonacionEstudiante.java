...
public class ClonacionEstudiante implements Cloneable {
	...
	public static void main(String args[]) {
		try {
			...
			System.out.println(s1.getEstId() + " Objeto String nombre " +
			s1.getNombre().getBytes() + " referencia : "
					+ s1.getReferencia());
			System.out.println(s2.getEstId() + " Objeto String nombre " + 
					s2.getNombre().getBytes() + " referencia : "
					+ s2.getReferencia());
