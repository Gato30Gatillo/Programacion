...
public class EjemploClaseGenerica<T> {
	...
	public String toString() {
		...
		return "EjemploClaseGenerica [operando1=" + operando1 + ", operando2=" +
		operando2 + "]";
	...
	public static void main(String[] args) {
		...
		System.out.println("¿Son iguales los dos operandos? La respuesta es " +
		dobleGenerico.comparacion());
		...
		System.out.println("¿Son los dos operandos iguales? La respuesta es " +
		integerGenerico.comparacion());
