...
public class AppBiblio {
    ...
    private static void ordenarPor(Biblioteca biblio){
		...
		case 1 -> {
			...
			biblio.ordenarLibrosPor(
					(l1, l2) -> l1.getTitulo().compareTo(l2.getTitulo()));
		...
		case 2 -> {
			...
			biblio.ordenarLibrosPor(
					(l1, l2) -> l1.getAutor().compareTo(l2.getAutor()));
		...
		case 3 -> {
			...
			biblio.ordenarLibrosPor(
					(l1, l2) -> l1.getAnnioPublicacion()-(l2.getAnnioPublicacion()));
		...
		case 4 -> {
			...
			biblio.ordenarLibrosPor(
					(l1, l2) -> l1.getReferencia().compareTo(l2.getReferencia()));
