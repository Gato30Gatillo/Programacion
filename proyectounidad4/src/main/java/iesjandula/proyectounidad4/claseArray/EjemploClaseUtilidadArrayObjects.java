...
public class EjemploClaseUtilidadArrayObjects {
	...
	public static void main(String[] args) {
		...
		System.out.println("Array ordenado por el comparator de la clase Empleado, " 
		...
		System.out.println("Array ordenado por el comparator ComparatorEmpleadoNombre," 
		+ " ordenado por nombre:\n " + Arrays.toString(arrayEmpl));
		...
		System.out.println("Array ordenado por lambda, ordenado por id:\n " 
		+ Arrays.toString(arrayEmpl));

		Arrays.sort(arrayEmpl,new Comparator<Empleado>(){
		...
		System.out.println("Array ordenado por el comparator de empleado, apellidos-nombre,"
				+ " en paralelo, más rápido: " + Arrays.toString(arrayEmpl));
