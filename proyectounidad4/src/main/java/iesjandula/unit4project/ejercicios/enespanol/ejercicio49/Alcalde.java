...
public class Alcalde implements Comparable<Alcalde>, IAlcalde{
	...
	public String toString() {
		return "Alcalde [nombre=" + nombre + ", apellidos=" + apellidos + ", partido=" + 
	partido + "]";
	}
	...
	public int compareTo(Alcalde o) {
		...
		//String nombreAlc = this.nombre+this.apellido;
	...
	public String infoAlcalde() {
		// TODO Auto-generated method stub
		return "Nombre: "+ this.getNombre()+ " Apellidos: "+ this.getApellidos()+" Partido: "+
				this.getPartido();
	}
}
